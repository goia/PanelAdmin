	...
	if ( ! $interim_login ): ?>
                <p id="backtoblog">
                    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php esc_attr_e( 'Are you lost?' ); ?>">
                        <?php printf( __( '&larr; Back to / Regresar a %s' ), get_bloginfo( 'title', 'display' ) ); ?>
                    </a>
                </p>
                <?php endif; ?>
...
if ( get_option( 'users_can_register' ) ) {
            ...
            {
                    	$registration_url = sprintf( '<a href="http://lms.amodosoluciones.es/wp-login.php?action=register">Rexistrarse</a>', esc_url( wp_registration_url() ), __( 'Register' ) );
	...
	echo ' | ' . apply_filters( 'register', $registration_url );
            ...
            {
               	$registration_url = sprintf( '<a href="http://lms.amodosoluciones.es/wp-login.php?action=register">Register</a>', esc_url( wp_registration_url() ), __( 'Register' ) );
...
case 'register' :
	...
	login_header(__('Registration Form'), '<p class="message register">' . __('Register For This Site | Rexistrate neste sitio') . '</p>', $errors);
?>
                        <form name="registerform" id="registerform" action="<?php echo esc_url( site_url( 'wp-login.php?action=register', 'login_post' ) ); ?>" method="post" novalidate="novalidate">
                            <p>
                                <label for="user_login">
                                    <?php _e('Username | Usuario') ?>
                                        <br />
	...
	?>
                                <p id="reg_passmail">
                                    <?php _e( 'Registration confirmation will be emailed to you.<br/>A confirmación do seu rexistro sera enviada o seu correo' ); ?>
                                </p>
                                <br class="clear" />
                                <input type="hidden" name="redirect_to" value="<?php echo esc_attr( $redirect_to ); ?>" />
                                <p class="submit">
                                    <input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="<?php
         if(ICL_LANGUAGE_CODE == 'es'){esc_attr_e('Rexistrarse'); }
elseif(ICL_LANGUAGE_CODE == 'en') {esc_attr_e('Register / Rexistrarse'); }?>" />
                                </p>
                        </form>
                        ...
                        <p id="nav">
                            ...
                            <a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" title="<?php esc_attr_e( 'Password Lost and Found' ) ?>">
                                <?php _e( '<br/>Lost your password? | ¿Perdiches o tey password?' ); ?>
                            </a>
                        </p>
...
?>
                                                            ...
                                                            <?php echo esc_attr( $user_login ); ?>" size="20" /></label>
                                                </p>
                                                <p>
                                                    <label for="user_pass">
                                                        <?php _e('Password / Contraseña') ?>
                                                            <br />
	...
	?>
                                                    <p class="forgetmenot">
                                                        <label for="rememberme">
                                                            ...
                                                            <?php esc_attr_e('Remember Me / Recordame'); ?>
                                                        </label>
                                                    </p>
                                                    <p class="submit">
	...
	if ( get_option( 'users_can_register' ) ) {
        ...
        if(ICL_LANGUAGE_CODE == 'es') 
            {
                    	$registration_url = sprintf( '<a href="http://lms.amodosoluciones.es/wp-login.php?action=register">Rexistrarse</a>', esc_url( wp_registration_url() ), __( 'Register / Rexistro' ) );

		/** This filter is documented in wp-includes/general-template.php */
		echo apply_filters( 'register / Rexistro', $registration_url ) . ' | ';
                }
            elseif(ICL_LANGUAGE_CODE == 'en') 
            {
               $registration_url = sprintf( '<a href="http://lms.amodosoluciones.es/wp-login.php?action=register">Register | Rexistrarse</a>', esc_url( wp_registration_url() ), __( 'Register / Rexistro' ) );
	...
	?>
                                                        <br/>
                                                        <a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" title="<?php esc_attr_e( 'Password Lost and Found' ); ?>">
                                                            <?php _e( 'Lost your password? | ¿Perdeu a sua password?' ); ?>
                                                        </a>
                                                        <?php endif; ?>
                                                </p>
                                                <?php } ?>
