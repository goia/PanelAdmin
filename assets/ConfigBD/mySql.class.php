<? 
	...
	class mySQL{
		...
		const _DATABASE_NAME_DEVELOPMENT= 'PanelAdmin';
		const _USER_DEVELOPMENT 		= 'root';
		const _PASS_DEVELOPMENT 		= 'root';
		
		const _DATABASE_NAME_PRODUCTION	= 'PanelAdmin';
		const _USER_PRODUCTION 			= 'root';
		const _PASS_PRODUCTION 			= 'root';
